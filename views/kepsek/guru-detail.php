...
?>
<div class="card">
    <div class="card-header" style="display:flex; justify-style:space-between; align-items:center;">
        <h3>Biodata Guru (Monitoring Kepala Sekolah)</h3>
        <a href="<?= base_url('index.php?page=kepsek&action=guru') ?>" class="btn btn-secondary">← Kembali ke Data Guru</a>
    </div>
    <div class="card-body">
        <?php 
        ...
        <div class="detail-grid">
            ...
            <div class="detail-item"><label>Tahun Masuk</label><span><?= dg($guru,'tahun_masuk') ?></span></div>
        </div>
